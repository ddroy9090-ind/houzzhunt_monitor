                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div id="lead-form-wrapper" class="bg-white p-4 rounded shadow">
                            ...
                            <form id="lead-form" method="post" action="process_form">
                                ...
                                <!-- reCAPTCHA widget -->
                                <div class="g-recaptcha mb-3" data-sitekey="6LfsT9IrAAAAALx6HawW63nF2e1c9nLRJwXNDxTM"></div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6">
                    <div id="lead-form-wrapper" class="bg-white p-4 rounded shadow w-100">
                        <h4 class="">Start Your Mortgage Journey Today</h4>
                        <form id="lead-form-footer" method="post" action="process_form">
                            <div class="form-group mb-3">
                                <label for="name" class="form-label">Full Name</label>
                                <input type="text" class="form-control" id="name" name="name" required />
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label for="location" class="form-label">Where is the property located? *</label>
                                <select name="location" id="location" name="location" class="form-select form-control" required>
                                    <option value="Dubai">Dubai</option>
                                    <option value="Abu Dhabi">Abu Dhabi</option>
                                    <option value="Sharjah">Sharjah</option>
                                    <option value="Ajman">Ajman</option>
