...
<head>
    ...
    <title>RAK Investor Guide 2025 | Ras Al Khaimah Real Estate Investment Insights</title>
    <meta name="description"
        content="Download the RAK Investor Guide 2024 and explore Ras Al Khaimah’s booming real estate market. Learn about top projects, ROI forecasts, visa roadmap, and off-plan vs ready property strategies.">
    <meta name="keywords"
        content="RAK Investor Guide, Ras Al Khaimah property investment, RAK real estate 2024, Al Marjan Island, Al Hamra, RAK off-plan projects, RAK property ROI, RAK visa guide, UAE real estate investment">
    ...
    <style>
        ...
        #hearo-wrapper {
            position: relative;
            background: url('assets/images/banner/ras-alkhamiah-guide-banner.webp') center center/cover no-repeat;
            color: #fff;
            padding: 60px 0;
            min-height: 100vh;
            display: flex;
        ...
        textarea.form-control:focus,
        select.form-control:focus {
            border: 1px #004a44 solid !important;
            box-shadow: none;
        }
        ...
        .guide-modal .input-icon {
            position: relative;
        }

        .guide-modal .input-icon i {
            position: absolute;
            top: 50%;
            left: 12px;
            transform: translateY(-50%);
        ...
        .guide-modal .input-icon .form-control {
            padding-left: 40px;

        }

        .guide-modal .btn-cancel {
            background: #f8f9fa;
...
<body>
    ...
    <div id="hearo-wrapper">
        <div class="logo">
            <a href="index.php"><img src="assets/images/logo/logo.svg" alt="" width="200"></a>
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div id="leftWrapper">
                        <h1>Ras Al Khaimah Investor Guide 2025</h1>
                        <p>
                            Ras Al Khaimah (RAK) is no longer a hidden gem. With global projects like Wynn Resorts,
                            record-breaking developments, and booming tourism, it’s fast becoming one of the UAE’s
                            most exciting property markets for early investors.
                        </p>
                        <div class="text-center">
                            <button class="btn btn-download" id="modal-btn" data-bs-toggle="modal"
                ...
                <div class="col-lg-5">
                    <div id="rightWraper">
                        <h4>Download the HouzzHunt <br> Investor Guide</h4>
                        ...
                        <form action="">
                            ...
                            <div class="form-group input-icon">
                                ...
                                <select id="investmentPlaybook" name="investmentPlaybook"
                                    ...
                                    <!-- <option value="Select Options">Select Guide For?</option> -->
                                    <option value="">Ready to invest and want expert insights</option>
                                    <option value="investing_soon">Exploring Dubai but still learning about the market</option>
                                    <option value="researching">Comparing property types to find the best returns</option>
                                    <option value="curious">New to real estate investment and need guidance</option>
                                    <option value="agent">Professional/advisor looking for reliable research</option>
                                </select>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="investor-guide-content">
                        <h2 class="heading-title">Navigate <span>Ras Al Khaimah Real Estate with Confidence</span></h2>
                        <p>This guide highlights RAK’s emerging real estate market, covering top communities like Al
                            Marjan Island, Mina Al Arab, and Al Hamra Village. Learn about freehold zones, Golden Visa
                            eligibility, tax-free benefits, and key growth drivers to make informed investment
                            decisions.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="leftContentImage">
                        <img src="assets/images/guides/rak-investor-guide.webp" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="rightContentSection">
                        <h2 class="heading-title">Let's find <span>your ideal investment</span></h2>
                        <p>Ras Al Khaimah Investor Guide is trusted by investors seeking high-potential opportunities in
                            a growing market. From first-time buyers to portfolio builders, our insights help you
                            capture strong rental yields and long-term capital appreciation.</p>
                        <p>Our consultants provide practical guidance on emerging developments, legal protections, and
                            smart portfolio strategies, ensuring investors navigate RAK’s market with confidence.</p>
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#downloadModal" class="gradient-btn btn-green-glossy">Speak to a consultant</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="market-section text-center">
        <div class="container">
            ...
            <p class="mb-5">
                Key numbers driving RAK’s investment case:
            </p>

            <div class="row g-4">
                <div class="col-md-3 col-sm-6">
                    <div class="stat-box p-4 h-100">
                        <span><img src="assets/icons/cash.png" alt="Yields Icon"></span>
                        <h3>7–9%</h3>
                        <h6>Avg Yields</h6>
                        <p>outperforming most global markets</p>
                        <strong>↗ Strong ROI</strong>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-box p-4 h-100">
                        <span><img src="assets/icons/globe.png" alt="Tourists Icon"></span>
                        <h3>1.28M</h3>
                        <h6>Tourists</h6>
                        <p>in 2024</p>
                        <strong>+20% YoY</strong>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-box p-4 h-100">
                        <span><img src="assets/icons/grow-up.png" alt="Tourist Growth Icon"></span>
                        <h3>3.5M</h3>
                        <h6>Tourists Target</h6>
                        <p>by 2030</p>
                        <strong>↗ Strong demand driver</strong>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="stat-box p-4 h-100">
                        <span><img src="assets/icons/balance-sheet.png" alt="Hotel Keys Icon"></span>
                        <h3>19,000+</h3>
                        <h6>Hotel Keys</h6>
                        <p>by 2030</p>
                        <strong>↗ Expanding hospitality</strong>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-4">
                <div class="col-lg-8">
                    ...
                    <p class="text-muted">
                        Everything you need to understand why RAK is on every investor’s radar.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="key-points">
                        ...
                        <div class="ms-3 text-start">
                            ...
                            <p class="text-muted mb-0">
                                Review RAK’s current real estate performance with growth factors driving its rise. Learn
                                how market momentum and 2025 outlook shape smart investor opportunities.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="key-points">
                        ...
                        <div class="ms-3 text-start">
                            ...
                            <p class="text-muted mb-0">
                                Explore Al Marjan Island, Mina Al Arab, and Al Hamra Village. A district-level look at
                                RAK’s communities offering strong yields, growth, and long-term investment appeal.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="key-points">
                        ...
                        <div class="ms-3 text-start">
                            ...
                            <p class="text-muted mb-0">
                                Understand RAK’s freehold access, Golden Visa benefits, escrow protections, and tax-free
                                structure. Clear insights simplify compliance and safeguard confidence.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="key-points">
                        ...
                        <div class="ms-3 text-start">
                            ...
                            <p class="text-muted mb-0">
                                Learn portfolio approaches crafted for RAK’s emerging-market upside. Practical
                                strategies help investors time entries, diversify holdings, and capture long-term value.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="assets/images/guides/rak-mockup.webp"
    ...
    <section class="faq">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="text-muted">
                    Get answers to the most common questions about Ras Al Khaimah real estate investment
                </p>
            </div>
            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="accordion-item shadow-sm mb-3 border-0 rounded">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq1">
                            Why invest in Ras Al Khaimah real estate?
                        </button>
                    </h2>
                    <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            RAK offers high yields (7–9%), low entry prices, tax-free returns, and massive upside from
                            mega-projects like Wynn Resorts.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item shadow-sm mb-3 border-0 rounded">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq2">
                            What’s the Golden Visa requirement?
                        </button>
                    </h2>
                    <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            AED 2M+ property purchase secures a 10-year residency visa for investors and families.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item shadow-sm mb-3 border-0 rounded">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse"
                            data-bs-target="#faq3">
                            Which areas are most promising?
                        </button>
                    </h2>
                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            Al Marjan Island (growth hub), Mina Al Arab (family lifestyle), Al Hamra Village (expat
                            community + rentals).
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item shadow-sm mb-3 border-0 rounded">
                    ...
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div class="accordion-body text-muted">
                            Stick with reputable developers, balance off-plan and ready, and avoid over-leverage in an
                            emerging market.
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade guide-modal" id="downloadModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center pt-0">
                    <h5 class="modal-title heading-title">Get Your Free<span> Investor Guide</span></h5>
                    <p class="mb-4 para">Enter your details to download the complete Dubai Real Estate Investment Guide
                        (PDF)</p>
                ...
                <div class="modal-footer border-0 justify-content-between">
                    ...
                    <button type="button" class="btn btn-download"> <img src="assets/icons/download.png" width="16px"
                            alt=""> Download Guide</button>
                </div>
            </div>
        </div>
    </div>
