(function ($) {
  ...
  $(window).on("scroll", function () {
    ...
    $(
      ".service-icon-one, .service-left-one, .about-right-one, .work-left-one, .service-icon-two, .why-choose-box-two, .nav-link, .about-icon-three, .service-box-three, .why-choose-box-three, .benefit-box-four, .counter-one, .banner-box-icon-five "
    ).each(function () {
      var $this = $(this);
      ...
      if (
        ...
        position + $this.height() >= scrollTop
      ) {
      ...
      if (
        ...
        $this
          .find(
            ".service-left-details-one , .about-details-one, .work-details-one, .counter-box-one"
          )
          .addClass("active");
      } else {
        $this
          .find(
            ".service-left-details-one, .about-details-one, .work-details-one "
          )
          .removeClass("active");
      }
    });
  ...
  if ($(".testimonial-slider-one").length) {
    ...
    $(".testimonial-slider-one").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/images/svg/aerrow-pre.svg" alt="icon">PREW</button>',
      nextArrow:
        '<button type="button" class="slick-next">Next<img src="assets/images/svg/aerrow-next.svg" alt="icon"></button>',
    });
  }
  ...
  if ($(".testimonial-section-two").length) {
    ...
    $(".testimonial-slider-two").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/images/svg/arrow-left.svg" alt="icon"></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="assets/images/svg/arrow-right.svg" alt="icon"></button>',
    });
  ...
  if ($(".portfolio-slider-two").length) {
    ...
    $(".portfolio-slider-two").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/images/svg/Next.svg" alt="icon"></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="assets/images/svg/Next-2.svg" alt="icon"></button>',
    });
  }
  ...
  if ($(".testimonial-slider-three").length) {
    ...
    $(".testimonial-slider-three-2").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/images/svg/aerrow-pre.svg" alt="icon"></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="assets/images/svg/aerrow-next.svg" alt="icon"></button>',
    });
  ...
  $(window).on("scroll", function () {
    // counter animation
    $(
      ".counter-one, .about-counter-two, .about-counter-four, .why-choose-left-four"
    ).each(function () {
      var $this = $(this);
      var position = $this.offset().top;
      var windowHeight = $(window).height();
  ...
  if ($(".testimonial-slider-five").length) {
    ...
    $(".testimonial-slider-five").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><img src="assets/images/testimonial/testimonial-five-pre.svg" alt="icon"></button>',
      nextArrow:
        '<button type="button" class="slick-next"><img src="assets/images/testimonial/testimonial-five-next.svg" alt="icon"></button>',
    });
  }
  ...
  if ($(".fillter-widget").length) {
    ...
    function updatePrice(position) {
      const value = Math.round(
        (position / sliderWidth) * (maxPrice - minPrice) + minPrice
      );
      $maxPrice.text(`$${value}`);
    ...
    $(".product-slide-item").each(function () {
      ...
      img.on("mousemove", function (e) {
        ...
        magnifier.css({
          ...
          "background-position": `-${x * zoom - magnifier.width() / 2}px -${
            y * zoom - magnifier.height() / 2
          }px`,
        });
      });
