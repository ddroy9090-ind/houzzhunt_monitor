...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width:767px) {
            ...
            .guide-modal .btn-cancel, .guide-modal .btn-download {
                width: 100%;
            }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="investor-guide-content">
                        <h2 class="heading-title">Navigate <span>Dubai Real Estate</span> with Confidence</h2>
                        <p>This guide unpacks Dubai’s property market with 2024 results and 2025 projections,
                            highlighting high-growth communities, legal frameworks, and off-plan opportunities. Learn
                            how to navigate the market, avoid common mistakes, and optimise returns with proven
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="leftContentImage">
                        <img src="assets/images/guides/dubai-investor-guide.webp" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="rightContentSection">
                        <h2 class="heading-title">Let's find <span>your ideal investment</span></h2>
                        <p>Dubai Investor Guide is trusted by global investors seeking clarity and results. From
                            first-time buyers to seasoned portfolio holders, our insights help you make data-backed
                            decisions and maximise both rental yields and long-term capital growth.</p>
                        <p>With expert consultants familiar with Dubai’s neighborhoods, off-plan developments, and legal
                            protections, we provide practical guidance tailored to your investment goals.</p>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="assets/images/guides/dubai-mockup.webp"
